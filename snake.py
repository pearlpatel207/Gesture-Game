...
def runGame():
    ...
    while True: # main game loop
        ...
        if prediction.argmax() == 1 and direction != RIGHT:
            direction = RIGHT
        elif prediction.argmax() == 0 and direction != LEFT:
            direction = LEFT
        elif prediction.argmax() == 3 and direction != DOWN:
            direction = DOWN
        elif prediction.argmax() == 2 and direction != UP:
            direction = UP
        ...
        # check if the worm has hit itself or the edge - if it hits itself: Game over
